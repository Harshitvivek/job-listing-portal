...
//     <div className={`${darkMode ? "dark" : ""}`}>
//       <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#121212] py-12">
//         <div className="w-full max-w-4xl bg-white dark:bg-[#1e1e1e] p-6 rounded-lg shadow-lg flex">
//           {loading ? (
//             <div className="w-full flex justify-between">
//               {/* Profile Section Skeleton */}
//               <div className="w-1/3 flex flex-col items-center border-r pr-6 animate-pulse space-y-2">
//                 <div className="rounded-full bg-gray-200 dark:bg-gray-500 h-40 w-40 mb-4"></div>
//                 <div className="h-6 bg-gray-200 dark:bg-gray-500 w-24 mb-2 rounded"></div>
//                 <div className="h-6 bg-gray-200 dark:bg-gray-500 w-32 mb-2 rounded"></div>
//                 <div className="h-6 bg-gray-200 dark:bg-gray-500 w-24 mb-6 rounded"></div>
...
//                 <img src={profileImg1} alt="Profile" className="rounded-full w-40 h-40 mb-4" />
//                 <p className="text-lg text-gray-700 dark:text-white mb-2 font-semibold">{userDetails.name}</p>
//                 <p className="text-gray-600 dark:text-gray-300 mb-2">{userDetails.email}</p>
//                 <p className="text-gray-600 dark:text-gray-300 mb-6">{userDetails.role}</p>
//                 {/* <button
//                   onClick={handleLogout}
//                   className="mt-4 bg-[#BB86FC] text-white py-2 px-6 rounded-lg hover:-[#BB86FC] transition duration-300"
//                 >
//                   Logout
//                 </button> */}
//               </div>
